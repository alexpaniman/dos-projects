...
_start:
	jmp entry			; Move entry point to other place, to
					; enable use of convenient includes
...
;; ------------------------------------------------------------
;; Load unit-test table, test selected itoa function, and show
;; log of the whole process
;; 
;; Side Effects: Prints log to the console
;; 
;; Return: None
;; 
...
;; ------------------------------------------------------------
;; Perform unit-tests of hex, binary, octal and decimal itoa
;; 
;; Destr: /AX/, /BX/, /CX/, /DX/, /DI/, /SI/
;; ------------------------------------------------------------
unit_test_itoa proc    
...
;; ------------------------------------------------------------
;; Non-automatic strchr test, designed for demonstration purpose
;; ------------------------------------------------------------
test_strchr proc
	lea si, @@message
	mov dl, '3'
...
;; ------------------------------------------------------------
;; Non-automatic strcpy test, designed for demonstration purpose
;; ------------------------------------------------------------
test_strcpy proc
	lea si, @@message
	lea di, @@space
...
;; ------------------------------------------------------------
;; Non-automatic atoi test, designed for demonstration purpose
;; ------------------------------------------------------------
test_atoi proc
	lea si, @@message
	call atoi_decimal
...
;; ------------------------------------------------------------
;; Test selected itoa function on current test
;;
;; Entry: /SI/ -- Pointer to itoa test entry
;; ------------------------------------------------------------
itoa_test proc
	mov word ptr dx, [si]
	add si, 2
...
;; ------------------------------------------------------------
;; Print selected itoa's test entry name
;;
;; Entry: /SI/ -- Pointer to itoa test entry
;; ------------------------------------------------------------
